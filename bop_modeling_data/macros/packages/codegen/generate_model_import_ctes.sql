{% macro codegen__generate_model_import_ctes(model_name, leading_commas = False) %}
    {{ return(adapter.dispatch('codegen__generate_model_import_ctes')(model_name, leading_commas)) }}
{% endmacro %}

{% macro default__codegen__generate_model_import_ctes(model_name, leading_commas) %}
