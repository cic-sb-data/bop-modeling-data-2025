...
{% macro expect__ignore_row_if_expression(ignore_row_if, columns) %}
    {{ adapter.dispatch('expect__ignore_row_if_expression') (ignore_row_if, columns) }}
{% endmacro %}

{% macro default__expect__ignore_row_if_expression(ignore_row_if, columns) %}
